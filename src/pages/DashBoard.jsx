...
// Mock data
const mockMembers = [
  { id: 1, email: "gokul@example.com", role: "user" },
  { id: 2, email: "trevor@example.com", role: "creator" },
];
...
function AdminDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 font-sans">
      {/* Sidebar */}
      <aside
        className={`fixed lg:relative ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300 ease-in-out w-64 bg-gray-900 text-white min-h-screen z-40 shadow-lg`}
      >
        ...
        <nav className="flex-1 p-6">
          ...
          <button
            ...
            className="w-full p-3 text-center bg-green-600 rounded-md hover:bg-green-700 transition text-lg font-medium text-white"
          >
            Logout
          </button>
        </div>
                  ...
                  <tr key={member.id}>
                    ...
                    <td className="py-2 px-4 border">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700 text-xs sm:text-sm"
                      >
                        Delete
                      </button>
                    </td>
