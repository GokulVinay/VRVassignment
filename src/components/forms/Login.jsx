...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    const mockUsers = [
      ...
      { email: "user123@example.com", password: "user123", role: "user" },
      { email: "creator123@example.com", password: "creator123", role: "vendor" },
    ];
    ...
    <div className="flex items-center justify-center min-h-screen bg-green-600">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full py-2 bg-orange-500 hover:bg-yellow-400 text-white font-semibold rounded-md transition duration-300"
          >
            Login
          </button>
        </form>
